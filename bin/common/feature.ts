  ...
  - Kotlin 数组
    ...
    outline:
      - 数组创建
        ...
        - MutableList
      - 访问元素
      - 查找元素：findd、firstOrNulld 、indexOfd 和 lastIndexOfd
      - 修改元素
      - 删除元素
      - 修改数组
      - 遍历数组
      - 数组转换
        ...
        - flatMap
        - reduce
      - 数组截取：subList、drop & take
      - 数组匹配：any、all
      - 数组过滤：filterd、filterIndexedd
      - 数组排序：sortedd、sortedBy、sortedDescending 和 sortedByDescending
    usage:
      - title: "创建数组"
